...
},{"process":"pBGv"}],"C4Nx":[function(require,module,exports) {
var define;
var e;function t(e){return(t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(e)}!function(t,o){"use strict";"undefined"!=typeof module&&module.exports?module.exports=o(require("jquery")):"function"==typeof e&&e.amd?e(["jquery"],function(e){return o(e)}):o(t.jQuery)}(this,function(e){"use strict";var o=function t(o,n){this.$element=e(o),this.options=e.extend({},t.defaults,n),this.matcher=this.options.matcher||this.matcher,this.sorter=this.options.sorter||this.sorter,this.select=this.options.select||this.select,this.autoSelect="boolean"!=typeof this.options.autoSelect||this.options.autoSelect,this.highlighter=this.options.highlighter||this.highlighter,this.render=this.options.render||this.render,this.updater=this.options.updater||this.updater,this.displayText=this.options.displayText||this.displayText,this.itemLink=this.options.itemLink||this.itemLink,this.itemTitle=this.options.itemTitle||this.itemTitle,this.followLinkOnSelect=this.options.followLinkOnSelect||this.followLinkOnSelect,this.source=this.options.source,this.delay=this.options.delay,this.theme=this.options.theme&&this.options.themes&&this.options.themes[this.options.theme]||t.defaults.themes[t.defaults.theme],this.$menu=e(this.options.menu||this.theme.menu),this.$appendTo=this.options.appendTo?e(this.options.appendTo):null,this.fitToElement="boolean"==typeof this.options.fitToElement&&this.options.fitToElement,this.shown=!1,this.listen(),this.showHintOnFocus=("boolean"==typeof this.options.showHintOnFocus||"all"===this.options.showHintOnFocus)&&this.options.showHintOnFocus,this.afterSelect=this.options.afterSelect,this.afterEmptySelect=this.options.afterEmptySelect,this.addItem=!1,this.value=this.$element.val()||this.$element.text(),this.keyPressed=!1,this.focused=this.$element.is(":focus"),this.changeInputOnSelect=this.options.changeInputOnSelect||this.changeInputOnSelect,this.changeInputOnMove=this.options.changeInputOnMove||this.changeInputOnMove,this.openLinkInNewTab=this.options.openLinkInNewTab||this.openLinkInNewTab,this.selectOnBlur=this.options.selectOnBlur||this.selectOnBlur,this.showCategoryHeader=this.options.showCategoryHeader||this.showCategoryHeader};o.prototype={constructor:o,setDefault:function(e){if(this.$element.data("active",e),this.autoSelect||e){var t=this.updater(e);t||(t=""),this.$element.val(this.displayText(t)||t).text(this.displayText(t)||t).change(),this.afterSelect(t)}return this.hide()},select:function(){var e=this.$menu.find(".active").data("value");if(this.$element.data("active",e),this.autoSelect||e){var t=this.updater(e);t||(t=""),this.changeInputOnSelect&&this.$element.val(this.displayText(t)||t).text(this.displayText(t)||t).change(),this.followLinkOnSelect&&this.itemLink(e)?(this.openLinkInNewTab?window.open(this.itemLink(e),"_blank"):document.location=this.itemLink(e),this.afterSelect(t)):this.followLinkOnSelect&&!this.itemLink(e)?this.afterEmptySelect(t):this.afterSelect(t)}else this.afterEmptySelect();return this.hide()},updater:function(e){return e},setSource:function(e){this.source=e},show:function(){var t,o=e.extend({},this.$element.position(),{height:this.$element[0].offsetHeight}),n="function"==typeof this.options.scrollHeight?this.options.scrollHeight.call():this.options.scrollHeight;if(this.shown?t=this.$menu:this.$appendTo?(t=this.$menu.appendTo(this.$appendTo),this.hasSameParent=this.$appendTo.is(this.$element.parent())):(t=this.$menu.insertAfter(this.$element),this.hasSameParent=!0),!this.hasSameParent){t.css("position","fixed");var i=this.$element.offset();o.top=i.top,o.left=i.left}var s=e(t).parent().hasClass("dropup")?"auto":o.top+o.height+n,r=e(t).hasClass("dropdown-menu-right")?"auto":o.left;return t.css({top:s,left:r}).show(),!0===this.options.fitToElement&&t.css("width",this.$element.outerWidth()+"px"),this.shown=!0,this},hide:function(){return this.$menu.hide(),this.shown=!1,this},lookup:function(t){if(this.query=null!=t?t:this.$element.val(),this.query.length<this.options.minLength&&!this.options.showHintOnFocus)return this.shown?this.hide():this;var o=e.proxy(function(){e.isFunction(this.source)&&3===this.source.length?this.source(this.query,e.proxy(this.process,this),e.proxy(this.process,this)):e.isFunction(this.source)?this.source(this.query,e.proxy(this.process,this)):this.source&&this.process(this.source)},this);clearTimeout(this.lookupWorker),this.lookupWorker=setTimeout(o,this.delay)},process:function(t){var o=this;return t=e.grep(t,function(e){return o.matcher(e)}),(t=this.sorter(t)).length||this.options.addItem?(t.length>0?this.$element.data("active",t[0]):this.$element.data("active",null),"all"!=this.options.items&&(t=t.slice(0,this.options.items)),this.options.addItem&&t.push(this.options.addItem),this.render(t).show()):this.shown?this.hide():this},matcher:function(e){return~this.displayText(e).toLowerCase().indexOf(this.query.toLowerCase())},sorter:function(e){for(var t,o=[],n=[],i=[];t=e.shift();){var s=this.displayText(t);s.toLowerCase().indexOf(this.query.toLowerCase())?~s.indexOf(this.query)?n.push(t):i.push(t):o.push(t)}return o.concat(n,i)},highlighter:function(e){var t=this.query;if(""===t)return e;var o,n=e.match(/(>)([^<]*)(<)/g),i=[],s=[];if(n&&n.length)for(o=0;o<n.length;++o)n[o].length>2&&i.push(n[o]);else(i=[]).push(e);t=t.replace(/[\(\)\/\.\*\+\?\[\]]/g,function(e){return"\\"+e});var r,a=new RegExp(t,"g");for(o=0;o<i.length;++o)(r=i[o].match(a))&&r.length>0&&s.push(i[o]);for(o=0;o<s.length;++o)e=e.replace(s[o],s[o].replace(a,"<strong>$&</strong>"));return e},render:function(t){var o=this,n=this,i=!1,s=[],r=o.options.separator;return e.each(t,function(e,o){e>0&&o[r]!==t[e-1][r]&&s.push({__type:"divider"}),this.showCategoryHeader&&(!o[r]||0!==e&&o[r]===t[e-1][r]||s.push({__type:"category",name:o[r]})),s.push(o)}),t=e(s).map(function(t,s){if("category"==(s.__type||!1))return e(o.options.headerHtml||o.theme.headerHtml).text(s.name)[0];if("divider"==(s.__type||!1))return e(o.options.headerDivider||o.theme.headerDivider)[0];var r=n.displayText(s);return(t=e(o.options.item||o.theme.item).data("value",s)).find(o.options.itemContentSelector||o.theme.itemContentSelector).addBack(o.options.itemContentSelector||o.theme.itemContentSelector).html(o.highlighter(r,s)),o.options.followLinkOnSelect&&t.find("a").attr("href",n.itemLink(s)),t.find("a").attr("title",n.itemTitle(s)),r==n.$element.val()&&(t.addClass("active"),n.$element.data("active",s),i=!0),t[0]}),this.autoSelect&&!i&&(t.filter(":not(.dropdown-header)").first().addClass("active"),this.$element.data("active",t.first().data("value"))),this.$menu.html(t),this},displayText:function(e){return void 0!==e&&void 0!==e.name?e.name:e},itemLink:function(e){return null},itemTitle:function(e){return null},next:function(t){var o=this.$menu.find(".active").removeClass("active").next();for(o.length||(o=e(this.$menu.find(e(this.options.item||this.theme.item).prop("tagName"))[0]));o.hasClass("divider")||o.hasClass("dropdown-header");)o=o.next();o.addClass("active");var n=this.updater(o.data("value"));this.changeInputOnMove&&this.$element.val(this.displayText(n)||n)},prev:function(t){var o=this.$menu.find(".active").removeClass("active").prev();for(o.length||(o=this.$menu.find(e(this.options.item||this.theme.item).prop("tagName")).last());o.hasClass("divider")||o.hasClass("dropdown-header");)o=o.prev();o.addClass("active");var n=this.updater(o.data("value"));this.changeInputOnMove&&this.$element.val(this.displayText(n)||n)},listen:function(){this.$element.on("focus.bootstrap3Typeahead",e.proxy(this.focus,this)).on("blur.bootstrap3Typeahead",e.proxy(this.blur,this)).on("keypress.bootstrap3Typeahead",e.proxy(this.keypress,this)).on("propertychange.bootstrap3Typeahead input.bootstrap3Typeahead",e.proxy(this.input,this)).on("keyup.bootstrap3Typeahead",e.proxy(this.keyup,this)),this.eventSupported("keydown")&&this.$element.on("keydown.bootstrap3Typeahead",e.proxy(this.keydown,this));var t=e(this.options.item||this.theme.item).prop("tagName");"ontouchstart"in document.documentElement?this.$menu.on("touchstart",t,e.proxy(this.touchstart,this)).on("touchend",t,e.proxy(this.click,this)):this.$menu.on("click",e.proxy(this.click,this)).on("mouseenter",t,e.proxy(this.mouseenter,this)).on("mouseleave",t,e.proxy(this.mouseleave,this)).on("mousedown",e.proxy(this.mousedown,this))},destroy:function(){this.$element.data("typeahead",null),this.$element.data("active",null),this.$element.unbind("focus.bootstrap3Typeahead").unbind("blur.bootstrap3Typeahead").unbind("keypress.bootstrap3Typeahead").unbind("propertychange.bootstrap3Typeahead input.bootstrap3Typeahead").unbind("keyup.bootstrap3Typeahead"),this.eventSupported("keydown")&&this.$element.unbind("keydown.bootstrap3-typeahead"),this.$menu.remove(),this.destroyed=!0},eventSupported:function(e){var t=e in this.$element;return t||(this.$element.setAttribute(e,"return;"),t="function"==typeof this.$element[e]),t},move:function(e){if(this.shown)switch(e.keyCode){case 9:case 13:case 27:e.preventDefault();break;case 38:if(e.shiftKey)return;e.preventDefault(),this.prev();break;case 40:if(e.shiftKey)return;e.preventDefault(),this.next()}},keydown:function(t){17!==t.keyCode&&(this.keyPressed=!0,this.suppressKeyPressRepeat=~e.inArray(t.keyCode,[40,38,9,13,27]),this.shown||40!=t.keyCode?this.move(t):this.lookup())},keypress:function(e){this.suppressKeyPressRepeat||this.move(e)},input:function(e){var t=this.$element.val()||this.$element.text();this.value!==t&&(this.value=t,this.lookup())},keyup:function(e){if(!this.destroyed)switch(e.keyCode){case 40:case 38:case 16:case 17:case 18:break;case 9:if(!this.shown||this.showHintOnFocus&&!this.keyPressed)return;this.select();break;case 13:if(!this.shown)return;this.select();break;case 27:if(!this.shown)return;this.hide()}},focus:function(e){this.focused||(this.focused=!0,this.keyPressed=!1,this.options.showHintOnFocus&&!0!==this.skipShowHintOnFocus&&("all"===this.options.showHintOnFocus?this.lookup(""):this.lookup())),this.skipShowHintOnFocus&&(this.skipShowHintOnFocus=!1)},blur:function(e){this.mousedover||this.mouseddown||!this.shown?this.mouseddown&&(this.skipShowHintOnFocus=!0,this.$element.focus(),this.mouseddown=!1):(this.selectOnBlur&&this.select(),this.hide(),this.focused=!1,this.keyPressed=!1)},click:function(e){e.preventDefault(),this.skipShowHintOnFocus=!0,this.select(),this.$element.focus(),this.hide()},mouseenter:function(t){this.mousedover=!0,this.$menu.find(".active").removeClass("active"),e(t.currentTarget).addClass("active")},mouseleave:function(e){this.mousedover=!1,!this.focused&&this.shown&&this.hide()},mousedown:function(e){this.mouseddown=!0,this.$menu.one("mouseup",function(e){this.mouseddown=!1}.bind(this))},touchstart:function(t){t.preventDefault(),this.$menu.find(".active").removeClass("active"),e(t.currentTarget).addClass("active")},touchend:function(e){e.preventDefault(),this.select(),this.$element.focus()}};var n=e.fn.typeahead;e.fn.typeahead=function(n){var i=arguments;return"string"==typeof n&&"getActive"==n?this.data("active"):this.each(function(){var s=e(this),r=s.data("typeahead"),a="object"==t(n)&&n;r||s.data("typeahead",r=new o(this,a)),"string"==typeof n&&r[n]&&(i.length>1?r[n].apply(r,Array.prototype.slice.call(i,1)):r[n]())})},o.defaults={source:[],items:8,minLength:1,scrollHeight:0,autoSelect:!0,afterSelect:e.noop,afterEmptySelect:e.noop,addItem:!1,followLinkOnSelect:!1,delay:0,separator:"category",changeInputOnSelect:!0,changeInputOnMove:!0,openLinkInNewTab:!1,selectOnBlur:!0,showCategoryHeader:!0,theme:"bootstrap3",themes:{bootstrap3:{menu:'<ul class="typeahead dropdown-menu" role="listbox"></ul>',item:'<li><a class="dropdown-item" href="#" role="option"></a></li>',itemContentSelector:"a",headerHtml:'<li class="dropdown-header"></li>',headerDivider:'<li class="divider" role="separator"></li>'},bootstrap4:{menu:'<div class="typeahead dropdown-menu" role="listbox"></div>',item:'<button class="dropdown-item" role="option"></button>',itemContentSelector:".dropdown-item",headerHtml:'<h6 class="dropdown-header"></h6>',headerDivider:'<div class="dropdown-divider"></div>'}}},e.fn.typeahead.Constructor=o,e.fn.typeahead.noConflict=function(){return e.fn.typeahead=n,this},e(document).on("focus.typeahead.data-api",'[data-provide="typeahead"]',function(t){var o=e(this);o.data("typeahead")||o.typeahead(o.data())})});var o=require("jquery");window.$=window.jQuery=o;var n="pk.eyJ1IjoibWljaGllbC1sZXltYW4iLCJhIjoiY2p6bDY2OTdjMGtpbjNic2FycHNqYzhrMiJ9.ixmQT1F7yzxXksnHbBco0A",i={mapStyle:"https://openmaptiles.github.io/positron-gl-style/style-cdn.json",network:"https://cyclenetworks.osm.be/brumob/data/network.geojson",route:"https://bike4brussels.osm.be/api",geocoder:"https://api.mapbox.com/geocoding/v5/mapbox.places/{0}.json?access_token=".concat(n,"&proximity=50.861%2C4.356&country=BE&bbox=3.9784240723%2C50.6485897217%2C4.7282409668%2C51.0552073386&limit=5&types=place,locality,neighborhood,address,poi"),reverseGeocoder:"https://api.mapbox.com/geocoding/v5/mapbox.places/{0},{1}.json?limit=1&access_token=".concat(n)};String.prototype.format=function(){var e=this;for(var t in arguments)e=e.replace(new RegExp("\\{"+t+"\\}","g"),arguments[t]);return e},mapboxgl.accessToken=n;var s=new mapboxgl.Map({container:"map",style:"mapbox://styles/mapbox/streets-v10",center:[4.388443,50.8486229],zoom:11,preserveDrawingBuffer:!0}),r=void 0,a=void 0,l=void 0,c=void 0,p={},u={},h="en",d=["fast","balanced","brussels","relaxed"],m="fast",f=navigator.language||navigator.userLanguage;if("nl"!==f&&"fr"!==f||(h=f),"undefined"!=typeof Storage){var v=localStorage.getItem("lang");v&&(h=v)}else console.log("Sorry, your browser does not support Web Storage.");var y={fast:"fast-instruction",relaxed:"relaxed-instruction",balanced:"balanced-instruction",brussels:"other-instruction"},g={"fastest-route":"fast","relaxed-route":"relaxed","balanced-route":"balanced","other-route":"brussels"};function w(e){if(e<60)return"1min";if(e<3600)return"".concat(Math.round(e/60),"min");var t=Math.floor(e/3600),o=Math.floor(e%3600/60);return"".concat(t," h ").concat(o,"min")}function b(e){return+(Math.round(e+"e+3")+"e-3")}function x(e,t){var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:d,n=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],i=arguments.length>4&&void 0!==arguments[4]?arguments[4]:h,s=G();A||"xs"===s||"sm"===s||_(),$(".route-instructions ul").html(""),$(".route-instructions  .instructions-resume").html(""),$(".route-instructions .elevation-info").html("<img src='./img/Loading.gif' style='width: 100%;'  alt=\"Loading...\" />"),p={},C(),o.forEach(function(o){k(e,t,o,n,i)}),P(e,t)}function k(e,t){var o,n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"balanced",r=!(arguments.length>3&&void 0!==arguments[3])||arguments[3],a=arguments.length>4&&void 0!==arguments[4]?arguments[4]:"en",l=R(e),c=R(t);o="fast"==n?"":n;var d="".concat(i.route,"/route?loc1=").concat(l,"&loc2=").concat(c,"&instructions=").concat(r,"&lang=").concat(a)+(""===o?"":"&profile=".concat(o));if(p[n]=[],u[n])try{u[n].abort()}catch(f){console.warn(f,u[n])}u[n]=$.ajax({dataType:"json",url:d,success:function(o){var i=[],r=[];for(var a in route=o.route.features,route){"Stop"===route[a].name&&i.push(route[a]),void 0===route[a].properties.cyclecolour?route[a].properties.cyclecolour="#979797":7!==route[a].properties.cyclecolour.length&&(route[a].properties.cyclecolour.length>7?route[a].properties.cyclecolour=route[a].properties.cyclecolour.substring(0,7):route[a].properties.cyclecolour="#979797");try{r.push(route[a].geometry.coordinates[0][2])}catch(f){console.log("Failed to read height info",f)}}p[n]=route;var l=$("#".concat(y[n]," .instructions-resume"));2===i.length?l.html("<div>".concat(b(i[1].properties.distance/1e3),"km</div><div>").concat(w(i[1].properties.time),"</div>")):l.html("");$("#".concat(y[n]," .elevation-info")).html('<div><canvas id="chart-'.concat(n,'" style="width: 100%; height: 100px"></canvas></div>')),z("chart-".concat(n),r);var c=$("#".concat(y[n]," ul"));if(c.html(""),c.append('<li class="startpoint-li">'.concat($("#fromInput").val(),"</li>")),o.instructions&&o.instructions.features)for(var u in o.instructions.features)c.append('<li class="type-'.concat(o.instructions.features[u].properties.type,"  angle-").concat(o.instructions.features[u].properties.angle,'">').concat(o.instructions.features[u].properties.instruction,"</li>"));c.append('<li class="endpoint-li">'.concat($("#toInput").val(),"</li>")),c.append("</ul>");var h=s.getSource(n);h?h.setData(o.route):n===m?s.addLayer({id:n,type:"line",source:{type:"geojson",data:o.route},paint:{"line-color":{type:"identity",property:"cyclecolour"},"line-width":6},layout:{"line-cap":"round"}}):s.addLayer({id:n,type:"line",source:{type:"geojson",data:o.route},paint:{"line-color":"grey","line-opacity":.25,"line-width":6},layout:{"line-cap":"round"}});P(e,t)},error:function(e,t,o){"abort"!==t&&($("#".concat(y[n]," .elevation-info")).html("en"===h?"Error :(":"fr"===h?"Erreur :(":"Fout :("),s.getLayer(n)&&s.removeLayer(n),s.getSource(n)&&s.removeSource(n),console.warn("Problem calculating route: ",o,t,e))}})}function C(){for(var e in d)profile=d[e],s.getLayer(profile)&&s.removeLayer(profile),s.getSource(profile)&&s.removeSource(profile)}function S(){void 0!==r&&void 0!==l||C(),void 0!==a&&a.remove(),void 0!==r&&(a=T(r,"#47b200")),void 0!==c&&c.remove(),void 0!==l&&(c=T(l,"#b50000")),void 0!==r&&void 0!==l?(x(r,l),K({loc1:r,loc2:l})):K(r?{loc1:r}:l?{loc2:l}:{})}function T(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"#3FB1CE";return new mapboxgl.Marker({color:t}).setLngLat(e).addTo(s)}function I(){var e,t,o=p[m],n=[];for(var i in o)if("Stop"===o[i].name)e?t=o[i].geometry.coordinates:e=o[i].geometry.coordinates;else if("LineString"===o[i].geometry.type)for(var s in o[i].geometry.coordinates)n.push(o[i].geometry.coordinates[s]);exported=L(e,t,n),exported&&E(exported,"Bike4Brussels-route.gpx",".gpx")}function L(e,t,o){if(o&&e&&t){var n='<?xml version="1.0" encoding="UTF-8"?><gpx xmlns="http://www.topografix.com/GPX/1/1" creator="RouteYou" version="1.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.topografix.com/GPX/1/1 http://www.topografix.com/GPX/1/1/gpx.xsd">';for(var i in n+='<wpt lat="'.concat(e[1],'" lon="').concat(e[0],'">\n            <name>Start</name>\n            <desc>Startpoint route</desc>\n            <type>Marker</type>\n        </wpt>\n        <wpt lat="').concat(t[1],'" lon="').concat(t[0],'">\n            <name>End</name>\n            <desc>Endpoint route</desc>\n            <type>Marker</type>\n        </wpt>'),n+="\n\t\t<trk>\n            <name>BikeForBrussels Export</name>\n            <desc>Route exported using the Bike For Brussels Routeplaner.</desc>\n            <trkseg>",o)n+='\n\t\t\t\t<trkpt lat="'.concat(o[i][1],'" lon="').concat(o[i][0],'">\n                    <ele>').concat(o[i][2],"</ele>\n                </trkpt>");return n+="\n\t\t\t</trkseg>\n        </trk>\n    </gpx>"}alert(ne("routeMissing",h))}function E(e,t,o){var n=new Blob([e],{type:o});if(window.navigator.msSaveOrOpenBlob)window.navigator.msSaveOrOpenBlob(n,t);else{var i=document.createElement("a"),s=URL.createObjectURL(n);i.href=s,i.download=t,document.body.appendChild(i),i.click(),setTimeout(function(){document.body.removeChild(i),window.URL.revokeObjectURL(s)},0)}}function B(){$(".geocoder-input").typeahead({source:function(e,t){$.getJSON(i.geocoder.format(e),function(e){var o=[];for(var n in e.features)o.push({name:e.features[n].text+" ("+e.features[n].place_name+")",loc:e.features[n].center});t(o),V(document.getElementById("fromInput")),Z(document.getElementById("toInput"))})},matcher:function(e){return!0},afterSelect:function(e){var t=this.$element.attr("id");"fromInput"==t?r=e.loc:"toInput"==t?l=e.loc:console.warn("FIELD NOT FOUND!"),S()}})}function O(e,t){var o=e[0],n=e[1];$.getJSON(i.reverseGeocoder.format(o,n),function(e){t(e.features[0].text+" ("+e.features[0].place_name+")")})}function N(){navigator.geolocation?(navigator.geolocation.getCurrentPosition(F,D),"undefined"!=typeof Storage&&localStorage.removeItem("geolocation.permission.denieddate")):console.warn("Geolocation is not supported by this browser.")}function F(e){r=[e.coords.longitude,e.coords.latitude],S(),O(r,function(e){$("#fromInput").val(e),V(document.getElementById("fromInput"))})}function D(e){e.code===e.PERMISSION_DENIED?(console.log("Geolocation permission denied"),"undefined"!=typeof Storage&&localStorage.setItem("geolocation.permission.denieddate",new Date)):console.warn("Accessing geolocation failed.",e)}function P(e,t){var o=new mapboxgl.LngLatBounds;o.extend(e),o.extend(t);var n=50;A&&(n+=$("#sidebar-right-container").width()),s.fitBounds(o,{padding:{top:75,right:n,bottom:75,left:50}})}function H(){var e=r;r=l,l=e;var t=$("#fromInput"),o=$("#toInput"),n=t.val();t.val(o.val()),o.val(n),S()}function R(e){var t=[];return t[0]=e[1],t[1]=e[0],t}s.on("load",function(){s.addSource("dem",{type:"raster-dem",url:"mapbox://mapbox.terrain-rgb"}),s.addLayer({id:"hillshading",source:"dem",type:"hillshade"})}),s.on("click",function(e){var t,o=[[e.point.x-5,e.point.y-5],[e.point.x+5,e.point.y+5]],n=s.queryRenderedFeatures(o,{});for(var i in n)-1!==$.inArray(n[i].layer.id,d)&&(t||(t=n[i].layer.id));if(t)U(t);else{var a=[e.lngLat.lng,e.lngLat.lat];void 0===r?O(r=a,function(e){$("#fromInput").val(e),V(document.getElementById("fromInput"))}):O(l=a,function(e){$("#toInput").val(e),Z(document.getElementById("toInput"))}),S()}}),Date.prototype.addDays=function(e){var t=new Date(this.valueOf());return t.setDate(t.getDate()+e),t},B();var j,A=!1,M=!1;function _(){$("#sidebar-right-container").toggleClass("hidden-sidebar"),(A=!A)?($("#top-overlay-center-spacer").addClass("col-lg-1").addClass("col-md-0").removeClass("col-lg-2").removeClass("col-md-2"),$("#top-overlay-input").addClass("col-lg-7").removeClass("col-lg-8")):($("#top-overlay-center-spacer").addClass("col-lg-2").addClass("col-md-2").removeClass("col-lg-1").removeClass("col-md-0"),$("#top-overlay-input").addClass("col-lg-8").removeClass("col-lg-7"))}function q(e){e=e.replace("-mobile",""),U(g[e])}function U(e){if(m=e,r&&l){for(var t in y)try{s.getLayer(t)&&(s.setPaintProperty(t,"line-color","grey"),s.setPaintProperty(t,"line-opacity",.25))}catch(o){console.warn(o)}s.getLayer(e)&&(s.setPaintProperty(e,"line-color",{type:"identity",property:"cyclecolour"}),s.setPaintProperty(e,"line-opacity",1),s.moveLayer(e))}$(".route-instructions").addClass("height-zero"),$("#".concat(y[e])).removeClass("height-zero"),$("#sidebar-top>span").removeClass("active"),$("#top-overlay-profile-buttons-mobile>span").removeClass("active"),$("#".concat(W(g,e))).addClass("active"),$("#".concat(W(g,e),"-mobile")).addClass("active")}function G(){var e,t=window.innerWidth>0?window.innerWidth:screen.width;switch(!0){case t<=576:e="xs";break;case t>576&&t<=768:e="sm";break;case t>768&&t<=992:e="md";break;case t>992&&t<=1200:e="lg";break;case t>1200:e="xl"}return e}function W(e,t){return Object.keys(e).find(function(o){return e[o]===t})}function z(e,t){var o=document.getElementById(e).getContext("2d");new Chart(o,{type:"line",data:{labels:Array.apply(null,{length:t.length}).map(Number.call,Number),datasets:[{label:"",data:t,fill:!1,borderColor:"rgb(255, 255, 255)",lineTension:.1}]},options:{legend:{display:!1},elements:{point:{radius:0}},scales:{xAxes:[{display:!1}],yAxes:[{display:!1}]}}})}function Q(e){switch(e.id){case"label-option-EN":h="en";break;case"label-option-FR":h="fr";break;case"label-option-NL":h="nl"}"undefined"!=typeof Storage&&localStorage.setItem("lang",h),r&&l&&x(r,l,d,!0,h),J(h)}function X(){var e=new Image;e.id="map-pic",e.src=document.getElementsByClassName("mapboxgl-canvas")[0].toDataURL();var t='<head><title>Bike For Brussels - Route export</title><link href="style/printstyle.css" rel="stylesheet" type="text/css"><link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.1/css/bootstrap.min.css"\n          integrity="sha384-WskhaSGFgHYWDcbwN70/dfYBj47jz9qbsMId/iRN3ewGhXQFZCSftd1LZCfmhktB" crossorigin="anonymous"></head><body><h1>Bike For Brussels - Routeplanner</h1><p id=\'image_for_crop\'></p><div id=\'instructionsPrintContainer\'>'+document.getElementById(y[m]).innerHTML+"</div></body>";window.frames.print_frame.document.body.innerHTML=t,window.frames.print_frame.document.getElementById("image_for_crop").appendChild(e),window.frames.print_frame.document.getElementsByClassName("elevation-info")[0].innerHTML="",window.frames.print_frame.document.getElementsByClassName("profile-explanation-icons")[0].innerHTML="",window.frames.print_frame.window.focus(),setTimeout(function(){window.frames.print_frame.window.print()},100)}function Y(e){var t=e?e.split("?")[1]:window.location.search.slice(1),o={};if(t)for(var n=(t=t.split("#")[0]).split("&"),i=0;i<n.length;i++){var s=n[i].split("="),r=void 0,a=s[0].replace(/\[\d*\]/,function(e){return r=e.slice(1,-1),""}),l=void 0;if(void 0===s[1])l=!0;else{var c=(l=s[1].toLowerCase()).split(",");l=void 0===c[1]?c[0]:c}o[a=a.toLowerCase()]?("string"==typeof o[a]&&(o[a]=[o[a]]),void 0===r?o[a].push(l):o[a][r]=l):o[a]=l}return o}function K(e){for(var t in currentUrl=window.location.href,currentUrl=currentUrl.split("?")[0]+"?",e)currentUrl+=t+"="+e[t]+"&";window.history.pushState("object or string","Title",currentUrl)}function J(e){$(".button-collapse-instructions").html(ne("instructionsCollapseButton",e)),$("#fromInput").attr("placeholder",ne("fromInputPlaceholder",e)),$("#toInput").attr("placeholder",ne("toInputPlaceholder",e)),$("#profile-button-text-fast").html(ne("profileNameFast",e)),$("#profile-button-text-balanced").html(ne("profileNameBalanced",e)),$("#profile-button-text-relaxed").html(ne("profileNameRelaxed",e)),$("#profile-button-text-networks").html(ne("profileNameNetworks",e)),$("#profile-button-text-fast-mobile").html(ne("profileNameFast",e)),$("#profile-button-text-balanced-mobile").html(ne("profileNameBalanced",e)),$("#profile-button-text-relaxed-mobile").html(ne("profileNameRelaxed",e)),$("#profile-button-text-networks-mobile").html(ne("profileNameNetworks",e)),$("#other-instruction div p").html(ne("profileDescriptionNetworks",e)),$("#relaxed-instruction div p").html(ne("profileDescriptionRelaxed",e)),$("#balanced-instruction div p").html(ne("profileDescriptionBalanced",e)),$("#fast-instruction div p").html(ne("profileDescriptionFast",e)),$("#other-instruction div .sub-title").html(ne("profileTitleNetwork",e)),$("#relaxed-instruction div .sub-title").html(ne("profileTitleRelaxed",e)),$("#balanced-instruction div .sub-title").html(ne("profileTitleBalanced",e)),$("#fast-instruction div .sub-title").html(ne("profileTitleFast",e)),$("#other-instruction div h4").html(ne("profileProposal",e)),$("#relaxed-instruction div h4").html(ne("profileProposal",e)),$("#balanced-instruction div h4").html(ne("profileProposal",e)),$("#fast-instruction div h4").html(ne("profileProposal",e)),$("#ModalExportOptions").html(ne("exportOptionsTitle",e)),$("#export-general-explanation").html(ne("exportgeneralexplanation",e)),$("#export-gpx-explanation").html(ne("exportgpxexplanation",e)),$("#export-print-explanation").html(ne("exportprintexplanation",e)),$("#exportgpxbutton").html(ne("exportgpxbutton",e)),$("#exportprintbutton").html(ne("exportprintbutton",e)),$(".btn-close-export").html(ne("close",e))}function V(e){e.value&&""!==e.value?($("#clearInputFieldFromButton").show(),$("#useLocationInputFieldButton").hide()):($("#clearInputFieldFromButton").hide(),$("#useLocationInputFieldButton").show(),M&&(console.log("setting location 1 to undef"),r=void 0,S()))}function Z(e){e.value&&""!==e.value?$("#clearInputFieldToButton").show():($("#clearInputFieldToButton").hide(),l=void 0,S())}function ee(){$("#fromInput").val(""),r=void 0,S(),V(document.getElementById("fromInput"))}function te(){$("#toInput").val(""),l=void 0,S(),Z(document.getElementById("toInput"))}jQuery("img.svg").each(function(){var e=jQuery(this),t=e.attr("id"),o=e.attr("class"),n=e.attr("src");jQuery.get(n,function(n){var i=jQuery(n).find("svg");void 0!==t&&(i=i.attr("id",t)),void 0!==o&&(i=i.attr("class",o+" replaced-svg")),i=i.removeAttr("xmlns:a"),e.replaceWith(i)},"xml")}),window.onload=function(){switch(U(m),$(".lang_label").removeClass("active"),h){case"en":$("#label-option-EN").addClass("active");break;case"fr":$("#label-option-FR").addClass("active");break;case"nl":$("#label-option-NL").addClass("active")}J(h);var e=Y();e.loc1?r=e.loc1:"undefined"!=typeof Storage&&new Date(localStorage.getItem("geolocation.permission.denieddate")).addDays(7)>new Date||setTimeout(function(){N()},2e3),e.loc2&&(l=e.loc2),r&&(O(r,function(e){$("#fromInput").val(e)}),$("#useLocationInputFieldButton").hide(),$("#clearInputFieldFromButton").show()),l&&(O(l,function(e){$("#toInput").val(e)}),$("#clearInputFieldToButton").show()),(r||l)&&S(),s.addControl(new mapboxgl.GeolocateControl({positionOptions:{enableHighAccuracy:!0},trackUserLocation:!0}),"top-left"),M=!0,"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(function(e){var t=!0,o=!1,n=void 0;try{for(var i,s=e[Symbol.iterator]();!(t=(i=s.next()).done);t=!0){i.value.unregister()}}catch(r){o=!0,n=r}finally{try{t||null==s.return||s.return()}finally{if(o)throw n}}})},window.addEventListener("beforeinstallprompt",function(e){e.preventDefault(),(j=e)&&(document.getElementById("btnAddToHomescreen").style.display="block")}),document.getElementById("btnAddToHomescreen").addEventListener("click",function(e){document.getElementById("btnAddToHomescreen").style.display="none",j.prompt(),j.userChoice.then(function(e){"accepted"===e.outcome?console.log("User accepted the A2HS prompt"):console.log("User dismissed the A2HS prompt"),j=null})});var oe={locationMissing:{en:"Please enter at least 2 locations before continuing.",fr:"Veuillez entrer au moins deux endroits avant de continuer.",nl:"Gelieve minstens 2 locaties op te geven alvorens verder te gaan."},routeMissing:{en:"No route found for the given selections.",fr:"Aucun itinéraire trouvé pour les sélections données.",nl:"Er is geen route gevonden voor de gegevens selecties."},instructionsCollapseButton:{en:"Instructions",fr:"Instructions",nl:"Instructies"},fromInputPlaceholder:{en:"From",fr:"De",nl:"Van"},toInputPlaceholder:{en:"To",fr:"À",nl:"Naar"},profileNameFast:{en:"Fast",fr:"Rapide",nl:"Snel"},profileNameBalanced:{en:"Balanced",fr:"Équilibré",nl:"Gebalanceerd"},profileNameRelaxed:{en:"Relaxed",fr:"Détendu",nl:"Ontspannen"},profileNameNetworks:{en:"Networks",fr:"Réseaux",nl:"Netwerk"},profileDescriptionFast:{en:"This profile minimizes the time to destination.",fr:"Ce profil minimise le temps de destination.",nl:"Dit profiel minimaliseert de tijd naar uw bestemming."},profileDescriptionBalanced:{en:"This profile avoids the biggest streets and prefers cycleways.",fr:"Ce profil évite les plus grandes rues et préfère les pistes cyclables.",nl:"Dit profiel vermijdt de grote wegen en verkiest voornamelijk het fietsnetwerk."},profileDescriptionRelaxed:{en:"This profile avoids big roads, highly prefers cycleways, avoids uncomfortable surfaces such as cobblestones, and avoids streets with parallel parked cars.",fr:"Ce profil évite les grandes routes, privilégie fortement les pistes cyclables, évite les surfaces inconfortables telles que les pavés, et évite les rues avec des voitures en stationnement parallèles.",nl:"Dit profiel vermijdt grote wegen, geeft de voorkeur aan fietspaden, vermijdt oncomfortabele oppervlakken zoals kasseien en vermijdt straten met parallel geparkeerde auto's."},profileDescriptionNetworks:{en:"This profile heavily prefers the Brussels cycle network.",fr:"Ce profil privilégie fortement le réseau cyclable Bruxellois.",nl:"Dit profiel verkiest het fietsnetwerk in Brussel."},profileTitleFast:{en:"This is the FAST route",fr:"C'est la route la plus RAPIDE.",nl:"Dit is de SNELSTE route."},profileTitleBalanced:{en:"This is the BALANCED route",fr:"C'est la route ÉQUILIBRÉE.",nl:"Dit is de GEBLANCEERDE route"},profileTitleRelaxed:{en:"This is the RELAXED route",fr:"C'est la route RELAXÉE",nl:"Dit is de ONTSPANNEN route"},profileTitleNetwork:{en:"This is the NETWORK route",fr:"C'est la route avec le RÉSEAU CYCLABLE",nl:"Dit is de NETWERK route"},profileProposal:{en:"Proposed route for you",fr:"C'est la route proposée pour vous",nl:"Dit is de voorgestelde route"},exportOptionsTitle:{en:"Export Options",fr:"Options d'exportation",nl:"Exporteer opties"},exportgeneralexplanation:{en:"Please select a method to export your route.",fr:"Veuillez sélectionner une méthode pour exporter votre itinéraire.",nl:"Selecteer een manier om uw route te exporteren."},exportgpxexplanation:{en:"You can export .gpx files to navigation applications and GPS devices.",fr:"Vous pouvez exporter des fichiers .gpx vers des applications de navigation et des appareils GPS",nl:"U kan de route exporteren naar een .gpx bestand. Dit kan geopend worden door navigatie applicaties en gps toestellen."},exportprintexplanation:{en:"Not into digital? Print it out!",fr:"Not into digital? Print it out!",nl:"Houdt u niet van digitaal? Print uw route op papier!"},exportgpxbutton:{en:"Export as .gpx file",fr:"Exporter au format .gpx",nl:"Exporteer als .gpx bestand"},exportprintbutton:{en:"Print",fr:"Imprimer",nl:"Afdrukken"},close:{en:"Close",fr:"Fermer",nl:"Sluit"}};function ne(e,t){return oe[e][t]}window.app={clearInputFieldFrom:ee,clearInputFieldTo:te,exportCurrentRoute:I,printExport:X,sidebarDisplayProfileHtmlId:q,swapOriginDestination:H,switchLanguage:Q,toFieldInputDetected:Z,toggleSidebar:_,useCurrentLocation:N};
},{"jquery":"juYr"}]},{},["C4Nx"], "window")